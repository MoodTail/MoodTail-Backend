...
public interface HistoryControllerDocs {
    ...
    @Operation(
            ...
            summary = "월간 히스토리 조회",
            description = "지정한 월의 테스트 결과, 테스트·음주 기록이 있는 날짜와 월간 리포트 열람 가능 "
                    + "여부를 조회합니다. 미래 월은 조회할 수 없습니다. days는 기록이 있는 날짜만 포함하며 "
                    + "음주 기록의 칵테일 상세 목록은 날짜별 히스토리 API에서 조회합니다."
    )
    @ApiResponses({
