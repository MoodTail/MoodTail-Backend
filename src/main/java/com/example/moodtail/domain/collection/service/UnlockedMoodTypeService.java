...
public class UnlockedMoodTypeService {

    private final UserUnlockedMoodTypeRepository userUnlockedMoodTypeRepository;

    public UnlockedMoodTypesResponse getUnlockedMoodTypes(Long userId, String role) {
        validateRole(role);
        return UnlockedMoodTypesResponse.from(userUnlockedMoodTypeRepository.findAllByUserId(userId));
    }
