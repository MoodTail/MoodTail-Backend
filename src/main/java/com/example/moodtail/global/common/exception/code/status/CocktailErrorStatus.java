...
public enum CocktailErrorStatus implements BaseCodeInterface {
    ...
    COCKTAIL_NOT_FOUND(HttpStatus.NOT_FOUND, "COCKTAIL404", "해당 칵테일을 찾을 수 없습니다."),
    RECIPE_NOT_FOUND(HttpStatus.NOT_FOUND, "RECIPE404", "해당 레시피를 찾을 수 없습니다."),
    INGREDIENT_NOT_FOUND(HttpStatus.NOT_FOUND, "INGREDIENT404", "해당 재료를 찾을 수 없습니다."),
    COCKTAIL_FAVORITE_ALREADY_EXISTS(HttpStatus.CONFLICT, "COCKTAIL409", "이미 즐겨찾기에 추가된 칵테일입니다."),
    COCKTAIL_FAVORITE_NOT_FOUND(HttpStatus.NOT_FOUND, "FAVORITE404", "즐겨찾기에 추가되지 않은 칵테일입니다.");
