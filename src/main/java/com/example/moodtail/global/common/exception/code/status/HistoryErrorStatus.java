...
public enum HistoryErrorStatus implements BaseCodeInterface {
    INVALID_REQUEST(HttpStatus.BAD_REQUEST, "HISTORY400", "히스토리 요청 값이 올바르지 않습니다."),
    DRINKING_RECORD_ALREADY_EXISTS(
            HttpStatus.CONFLICT,
            "HISTORY409",
            "해당 날짜에 같은 칵테일 음주 기록이 이미 있습니다."
    ),
    HISTORY_NOT_FOUND(HttpStatus.NOT_FOUND, "HISTORY404", "히스토리 기록을 찾을 수 없습니다."),
    TEST_RESULT_NOT_FOUND(HttpStatus.NOT_FOUND, "HISTORY_TEST404", "저장된 테스트 결과를 찾을 수 없습니다."),
    PHOTO_LIMIT_EXCEEDED(
            HttpStatus.CONFLICT,
            "HISTORY_PHOTO409",
            "날짜별 사진은 최대 5장까지 저장할 수 있습니다."
    ),
    PHOTO_NOT_FOUND(HttpStatus.NOT_FOUND, "HISTORY_PHOTO404", "히스토리 사진을 찾을 수 없습니다."),
