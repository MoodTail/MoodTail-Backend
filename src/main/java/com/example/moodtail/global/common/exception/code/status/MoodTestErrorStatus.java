...
public enum MoodTestErrorStatus implements BaseCodeInterface {
    ...
    MOOD_TEST_SHARED_RESULT_NOT_FOUND(HttpStatus.NOT_FOUND, "MOOD_TEST404", "공유된 테스트 결과를 찾을 수 없습니다."),
    MOOD_TEST_COCKTAIL_NOT_FOUND(HttpStatus.NOT_FOUND, "MOOD_TEST404", "추천 칵테일을 찾을 수 없습니다."),
    MOOD_TEST_RESULT_NOT_FOUND(HttpStatus.NOT_FOUND, "MOOD_TEST_404", "테스트 결과를 찾을 수 없습니다.");
