...
public enum ShareErrorStatus implements BaseCodeInterface {
    SHARE_INVALID_RECOMMENDATIONS_SIZE(HttpStatus.BAD_REQUEST, "SHARE400", "추천 칵테일은 정확히 3개여야 합니다."),
    SHARE_COCKTAIL_NOT_FOUND(HttpStatus.BAD_REQUEST, "SHARE400", "존재하지 않는 칵테일이 포함되어 있습니다.");
